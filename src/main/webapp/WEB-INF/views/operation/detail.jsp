								...
								<div class="col">
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="feFirstName" class="pntLbl">이름 :</label><input type="text" value="${pntInfo.pntNm }" style="width: 100px;border:0;" />

										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="feLastName" class="pntLbl">나이 :</label><input type="text" value="${pntInfo.age }" style="width: 100px;border:0;" />

										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="feEmailAddress" class="pntLbl">성별 :</label><input type="text" value="${pntInfo.pntSex }" style="width: 100px;border:0;" />
										</div>
									</div>
									<div class="form-row">
										<div class="form-group" style="display: table-cell">
											<label for="feheight" class="pntLbl">키 :</label><input type="text" value="${pntInfo.height }" style="width: 100px;border:0;" />
										</div>
									</div>
									<div class="form-row">
										<div class="form-group">
											<label for="feweight" class="pntLbl">체중 :</label><input type="text" value="${pntInfo.weight }" style="width: 100px;border:0;" />
										</div>
									</div>
									<div class="form-row">
										<div class="form-group">
							...
							<div class="row">
								<div class="col">
									<div class="form-row">
											...
											<div class="table" style="display: table;">
													<div class="table-row" style="display: table-row;">
														<div class="table-cell" style="display: table-cell; width: 65%;">검사 종류</div>
														<div class="table-cell" style="display: table-cell; width: 35%;">검사 일시</div>
													</div>
												<c:forEach var="operDetailVO" items="${operIns}">
												<div class="table-row" style="display: table-row;">
													<div class="table-cell" style="display: table-cell; width: 60%;text-align:left">${operDetailVO.sgNm}</div>
													<c:set var="inspDt" value="${operDetailVO.inspDt}"/>
													<div class="table-cell" style="display: table-cell; width: 40%;">${fn:substring(inspDt,0,4)}-${fn:substring(inspDt,4,6)}-${fn:substring(inspDt,6,8)} ${fn:substring(inspDt,8,10)}:${fn:substring(inspDt,10,12)}:${fn:substring(inspDt,12,14)}</div>
												</div>
											</c:forEach>
										</div>
								</div>
...
<!-- 									<div class="table-cell" style="display: table-cell; width: 20%;">투약량</div> -->
								...
								<c:forEach var="operDetailVO" items="${operPntInj}">
									<div class="table-row" style="display: table-row;">
										<div class="table-cell" style="display: table-cell; width: 60%;text-align:left">${operDetailVO.drugNm}</div>
